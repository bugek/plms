...
$(document).ready(function(){
	...
	submitHandler: function() {
		...
		function(data) {
			...
			switch(data) {
				case "ok" : preview_register(); break;
				case "false" : $('#register_form #student_id').after('<em id="err_student_id" htmlfor="student_id" generated="true" class="error" style="display: block;">รหัสนักเรียนซ้ำ</em>');
							  break;
				default: preview_register();
			}
		},'text');
   },
	rules: {
	...
	$( "#regist_bt" ).click(function() {
		$( "#register-message" ).find(':input').each(function() {
			switch(this.type) {
				case 'password':
